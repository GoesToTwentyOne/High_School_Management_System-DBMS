    ...
    <div class="container my-3">
        ...
        <form method="get">
            <select name="receiver" class="col-4">
                <option value="admin" name="receiver">For Admin</option>
                <option value="student" name="receiver">For Student</option>
                <option value="teacher" name="receiver">For Teacher</option>
                <option value="accounts" name="receiver">For Accounts</option>
            </select>
            ...
            if ($result) {
                ...
                $select = "SELECT
                    ...
                    FROM
                        notices AS n
                    WHERE
                        sender = 'teacher' AND receiver = '$receiver';";
            $result = mysqli_query($conn, $select);
            if ($result) {
                echo '
                    <h4 class="text-primary fw-bold">To '.$receiver.'</h4>
