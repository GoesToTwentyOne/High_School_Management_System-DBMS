    ...
    <div class="container">
        <?php if (isset($_POST['uploadPP'])) {       ?> <!-- UPLOAD Profile picture -->
            ...
            <form method="post" enctype="multipart/form-data">
                <div>Rename the picture first like: <p class="text-danger"> <?php echo $tid . '.jpg or ' . $tid . '.jpeg or ' . $tid . '.png'; ?></p>
                </div>
            ...
            <div class="container my-5 ">
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="phone" class="form-control" required value="<?php echo $phoNo ; ?>" >
                    </div>
                    <div class="mb-3">
                        <label>Date of Birth:</label>
                        <input type="date" name="dob" class="form-control" required value="<?php echo $rdob ; ?>">
                    </div>
                    <div class="mb-3">
